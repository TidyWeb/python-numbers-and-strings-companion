...
# print(f"Hello, my name is {name} and I am {age} years old.")`,
  ...
  "runnable-2": {
    code: `item_name = "Coffee"
price = 3.50
tax_rate = 0.13  # 13% tax
tax_percentage = 13  # Store as a simple number

# Calculate total price
total_price = price + (price * tax_rate)

# Format and print the receipt using one f-string
# Write your code here`,
    input: "",
  },
  playground: {
    code: `# F-String Playground
# Run these examples, then change one section at a time.

# 1. Several values
learner = "Sam"
course = "Python"
week = 3
print(f"{learner} is studying {course} in week {week}.")

# 2. An expression and decimal formatting
price = 12.50
quantity = 4
print(f"Order total: £{price * quantity:.2f}")

# 3. Percentages and thousands separators
completion = 0.875
visitors = 1250000
print(f"Completed: {completion:.0%}")
...
# 6. Literal curly brackets
topic = "variables"
print(f"Use {{curly brackets}} around {topic}.")`,
    input: "",
  },
};

const storagePrefix = "dynamic-f-strings-companion";
